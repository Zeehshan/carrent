...
class DrawerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Data> _options = <Data>[
      ...
      Data("My Listed Cars", () {}),
      Data("Notification", () {
        Navigator.push(context, Util.createRoute(page: NotificationPage()));
      }),
      Data("My Rented Cars", () {}),
      Data("My Financial Transaction", () {})
    ];
      ...
      return Padding(
        ...
        child: Text(text,
            style: TextStyle(
                ...
                color: Colors.white,
                fontWeight:
                    fontWieghtNormal ? FontWeight.normal : FontWeight.bold)),
      );
    }
